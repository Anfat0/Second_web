...
@app.route('/Hardware_Engineer.html')
def hardware():
    return render_template('Hardware_Engineer.html')

@app.route('/Electronic_Engineer.html')
def electronic():
    return render_template('Electronic_Engineer.html')

@app.route('/Course_projects.html')
def projects():
    return render_template('Course_projects.html')
